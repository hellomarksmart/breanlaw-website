        ...
        <div className="bg-stone-50">
          <div className="py-24 lg:py-30">
            <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
              {headings.map(item => (
                <>
                  <h1 className="text-4xl font-bold tracking-tight text-zinc-900 font-sans sm:text-5xl lg:text-6xl"> {item.h1_heading} </h1>
                  <p className="mt-6 text-lg text-zinc-400 font-sans max-w-3xl"> {item.h1_desc} </p>
                </>
              ))}
            </div>
          </div>
            ...
            <div className="relative bg-white shadow-xl">
              <div className="grid grid-cols-1 lg:grid-cols-3">
                <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-teal-500 to-teal-600 sm:px-10 xl:px-12 xl:py-6">
                  ...
                  {headings.map(item => (
                    <>
                      <h3 className="text-lg font-normal text-stone-100"> {item.h3_heading} </h3>
                      <p className="text-base text-stone-100 font-sans max-w-3xl"> {item.h3_desc} </p>
                    </>
                  ))}
                </div>
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12 shadow-md">
                  ...
                  <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    ...
                    {success ? (
                      headings.map(item => (
                        <p className="text-sm w-full font-bold tracking-tight text-zinc-400 font-sans sm:text-sm"> {item.success_message} </p>
                      ))
                    ) : ""}
                  </form>
                </div>
